...
<!-- DK: Only do pp() once, on the last model. DONE-->

<!-- DK: Add "The more data we have, the more narrow the posteriors which we create." DONE-->

<!-- DK: Highlight the fact that we have complete data for some, but not all, the rows in the Preceptor Table, like the height example in Chapter 1. Would not be true if the question was about candidates in the future. In that case, no data in Preceptor Table. DONE-->
...
$$ lived\_after_i =  \beta_0 + \beta_1 won_i + \beta_2 male_i + \epsilon_i $$
